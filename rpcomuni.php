...
if(isset($_POST['queryString'])) {
  ...
  if(strlen($queryString) >0) {
     $query =mysqli_query($GLOBALS["___mysqli_ston"], "select idcomuni, comune, codicepostale, provincia from tblcomuni where comune like '".$queryString."%' ORDER BY comune  LIMIT 8");
