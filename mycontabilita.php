...
//require("funzioni_generali.inc"); // da prendere sul server di produzione: non ce l'ho!
...
<html>
    <head>
        ...
        <?php
        // da togliere i comandi di apertura e fine di php. Fatto soltanto per remmare lo script html
