...
?>
	...
	<div id="pagina">
		<div id="contenutopagina">
			...
			<tr>
				<td colspan="4">Classe frequentata a scuola: </td>
			</tr>
			<tr>
			...
			adesione.</p>
			<br/><br/>
			<div style="float:left">Data:____________________ <?php /*echo date("d/m/Y");*/ ?></div><div style="float:right">Firma del genitore: _________________________________</div>
		</div>
	</div>
