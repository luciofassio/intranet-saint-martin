...
if ($copie > 0) {
	$nome = str_repeat("_",30);
	$cognome = str_repeat("_",30);
	$indirizzo = str_repeat("_",70);
	$sesso = str_repeat("_",2);
	$data_nascita = "__/__/_____";
	$luogo_nascita = str_repeat("_",50);
	$email = str_repeat("_",30);
	$classe = str_repeat("_",15);
	$sezione = str_repeat("_",10); 
	$parrocchia = str_repeat("_",50);
	$telefono_casa = str_repeat("_",20);
	$cellulare_personale = str_repeat("_",20);
	for($p = 0;$p < $copie; $p++) {
		StampaPagina();
	}
} else {
